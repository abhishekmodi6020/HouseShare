						...
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
								<ul class="nav navbar-nav ">
									...
									<li><a class="active" href="<?php echo base_url(); ?>admin_c/adminManageUser">Manage</a></li>
  ...
  <div class="container">
    ...
    <div class="col-md-6 gal-left gal_mar">
      ...
      <div class="content-grid-effect slow-zoom vertical text-center">
        <a href="<?php echo base_url(); ?>admin_c/adduser" class="b-link-stripe b-animate-go swipebox">
          <div class="img-box">
    ...
    <div class="col-md-6 gal-left gal_mar">
      ...
      <div class="content-grid-effect slow-zoom vertical text-center">
        <a href="<?php echo base_url(); ?>admin_c/adminupdatedelete" class="b-link-stripe b-animate-go  swipebox">
          <div class="img-box">
